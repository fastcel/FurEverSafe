...
export default function NGOAbuseReportDetails() {
  ...
  const position = [
    parseFloat(report.latitude) || 31.5204,
    parseFloat(report.longitude) || 74.3587,
  ];
              ...
              <div className="flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <p className="font-bold text-xl mb-3">
                    Animal:{" "}
                    <span className="text-[#c6287c]">{report.pet_type}</span>
                  </p>
                ...
                <div className="mt-auto">
                  ...
                  <div
                    className="border-[3px] border-black rounded-md h-64 bg-[#d9e5f2] relative overflow-hidden flex mb-8"
                  ...
                  <div className="flex mt-4">
                    <button
                      onClick={() =>
                        window.open(
                          `https://www.google.com/maps/search/?api=1&query=${report.address}`,
                          "_blank",
                        )
                      }
                ...
                <div className="mt-auto">
                    ...
                    <div className="grid grid-cols-2 grid-rows-2 h-full gap-1">
                      {report.images && report.images.length > 0 ? (
                        report.images.slice(0, 4).map((img, idx) => (
                          <div
                            key={idx}
                            className="bg-[#b3a18f] overflow-hidden"
                          >
                            <img
                              src={img}
                  ...
                  <div className="flex justify-end gap-6 mt-4">
                    ...
                    report.status === "under_review" ? (
                      ...
                      <div
                        className={`text-2xl font-black uppercase ${report.status === "action_taken" ? "text-green-600" : "text-red-600"}`}
                      >
